...
const ProgressSection = ({ patientData }) => {
  ...
  const totalDays = plan?.totalDays || 1; // avoid ÷0
      ...
      <div className="flex-1 grid gap-4 items-center grid-cols-1 sm:grid-cols-2">
        ...
        <div className="flex items-center justify-center">
          <Donut 
            ...
            size={170} 
            stroke={22} 
            centerColor={colorForPctBand(overall)} 
          />
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="!mt-4 grid grid-cols-3 gap-3 text-xs">
            ...
            <div className="bg-teal-50 text-teal-700 rounded-lg p-3 text-center">
              <div className="font-bold text-lg">{Math.max(totalDays - currentDay, 0)}</div>
              <div>Remaining</div>
            </div>
